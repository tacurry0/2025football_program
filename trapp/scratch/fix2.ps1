$path = "c:\Users\takahashi\Downloads\trapp\script.js"
...
"@
for ($i=183; $i -le 206; $i++) { $lines[$i] = "" }
$lines[183] = $stadiumMap
...
"@
for ($i=958; $i -le 981; $i++) { $lines[$i] = "" }
$lines[958] = $commonStadiumMap
...
"@
for ($i=1190; $i -le 1203; $i++) { $lines[$i] = "" }
$lines[1190] = $jTeamKws
