...
async function renderDashboard() {
            ...
            <div class="dash-card-body" style="background: white; color: #111; padding:10px 15px;">
              ...
              <div style="display:flex; gap: 15px;">
                 <div style="flex:1; display:flex; flex-direction:column; align-items:center; text-align:center;">
                    <img src="${myEmblem}" style="height:45px; margin-bottom:4px; filter: drop-shadow(0 2px 5px rgba(0,0,0,0.1)); cursor:pointer;" onclick="openClubSite('${myShortName === '\u65b0\u6f54' ? '\u30a2\u30eb\u30d3\u30ec\u30c3\u30af\u30b9\u65b0\u6f54' : '\u30ed\u30a2\u30c3\u30bd\u718a\u672c'}', event)">
    ...
    html += renderCard(nextNiigata, "ALBIREX NIIGATA", "var(--albirex-orange)", "\u65b0\u6f54");
    ...
    const refreshStandings = async () => {
      ...
      const updateStatsCard = (m, myKeyword) => {
        ...
        const J_TEAM_KWS = ["FC\u6771\u4eac", "\u6771\u4eacV", "\u6a2a\u6d5cF\u30fb\u30de\u30ea\u30ce\u30b9", "\u6a2a\u6d5cFC", "YS\u6a2a\u6d5c", "FC\u5927\u962a", "G\u5927\u962a", "C\u5927\u962a", "\u30bb\u30ec\u30c3\u30bd", "FC\u5c90\u961c", "FC\u4eca\u6cbb", "FC\u7409\u7403", "\u672d\u5e4c", "\u9e7a\u5cf6", "\u6d66\u548c", "\u6749", "\u753a\u753d", "\u5ddd\u5d0e", "\u6e58\u5357", "\u65b0\u6f54", "\u5bc5\u5c71", "\u91d1\u6ca2", "\u6e05\u6c34", "\u85e4\u679d", "\u6cbc\u6d25", "\u5c36\u753d", "\u540d\u53e4\u5c4b", "\u5c90\u961c", "\u4eac\u90fd", "\u795e\u6238", "\u5948\u826f", "\u9ce5\u53d6", "\u5ca1\u5c71", "\u5e83\u5cf6", "\u5c71\u53e3", "\u8b89\u5c90", "\u5fb3\u5cf6", "\u611b\u5a9b", "\u4eca\u6cbb", "\u798f\u5ca1", "\u535d\u4e5d\u5dde", "\u9ce5\u6816", "\u9577\u5d0e", "\u718a\u672c", "\u5927\u5206", "\u5bae\u5d0e", "\u9e7a\u5150\u5cf6", "\u7409\u7403", "\u9ad8\u77e5", "\u6ecb\u8cc0", "\u516b\u6238", "\u76db\u5ca1", "\u79cb\u7530", "\u5c71\u5f62", "\u4ed9\u53f0", "\u798f\u5cf6", "\u6c34\u6238", "\u7fa4\u99ac", "\u6803\u6728", "\u5927\u5bae", "\u5343\u8449", "\u76f8\u6a21\u539f", "\u7532\u5e9c", "\u677e\u672c", "\u9577\u91ce"];
        let oppData = null;
        let bestLen = 0;
      ...
      updateStatsCard(nextNiigata, "\u65b0\u6f54");
  ...
  function updateDashboardPrevResults() {
    ...
    const updateUI = (club, teamKw, match) => {
      ...
      const updateHalf = (prefix, kw) => {
        const past = officialResults.filter(r => {
          ...
          if (r.club && r.opponent) {
            const tMatchStatic = (kw === "\u65b0\u6f54" ? r.club === "niigata" : r.club === "kumamoto");
    ...
    updateUI("niigata", "\u65b0\u6f54", nextNiigata);
